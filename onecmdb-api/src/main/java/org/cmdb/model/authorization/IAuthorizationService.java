...
import org.cmdb.model.ICi;
import org.cmdb.service.IService;
import org.cmdb.service.ISession;
...
public interface IAuthorizationService extends IService {
	...
	public RBACSession setupRBAC(ISession session, List<String> roleNames);
}
